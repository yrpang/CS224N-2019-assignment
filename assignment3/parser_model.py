...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden = nn.Linear(
            self.n_features*self.embed_size, self.hidden_size, True)
        nn.init.xavier_normal_(self.embed_to_hidden.weight)
        self.dropout = nn.Dropout(p=dropout_prob)
        self.hidden_to_logits = nn.Linear(self.hidden_size, n_classes, True)
    ...
    def forward(self, t):
        ...
        # logits = F.softmax(self.hidden_to_logits(h))
